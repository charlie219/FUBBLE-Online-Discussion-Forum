...
if(mysqli_num_rows($q)>0 and substr($v,0,7)=='NOC0190'){
	$nam=$row['NAME'];
$data=$row['DATA'];
echo("<div style='color:white'><center><h1> Topic:- ".$nam."</h1><br><br><h3 align=left class='body-rl'>".$data);
echo("</h3><h3></div><center><form action=cmnt.php method='post'>
